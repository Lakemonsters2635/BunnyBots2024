...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    // left buttons
     Trigger runLeftVacuumButton = new JoystickButton(leftJoystick, Constants.RUN_LEFT_VACUUM_BUTTON);
     Trigger runRightVacuumButton = new JoystickButton(leftJoystick, Constants.RUN_RIGHT_VACUUM_BUTTON);
