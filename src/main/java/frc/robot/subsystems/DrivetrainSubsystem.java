...
public class DrivetrainSubsystem extends SubsystemBase {
    ...
    // Sets default alliance to blue can be overwritten in shuffleboard
  ...
  public Command createPath(Pose2d startPose, Translation2d middlePose, Pose2d endPose, double endRot, boolean mirrorX, boolean centerOfRotationCamera){
    ...
    // }
    PIDController xController = new PIDController(26, 12, 0);
    PIDController yController = new PIDController(26, 12, 0);
